...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('./rbbase/lib/exif')
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./rbbase/lib/myfunc')
//=================================================//
var low
try {
low = require('lowdb')
} catch (e) {
low = require('./rbbase/lib/lowdb')}
//=================================================//
const { Low, JSONFile } = low
const mongoDB = require('./rbbase/lib/mongoDB')
//=================================================//
...
new mongoDB(opts['db']) :
new JSONFile(`rbbase/dbnye/database.json`)
)
...
browser: ['RB-BOTZ Multi Device','Safari','1.0.0'],
auth: state})
//=================================================//
...
let buttonMessage = {
document: fs.readFileSync('./rbbase/lib/tes.xlsx'),
mimetype: feler,
...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await haikal.getName(i + '@s.whatsapp.net')}\nFN:${await haikal.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:kuramakill02@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://https://www.instagram.com/rb_857/?hl=id\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`})}
//=================================================//
...
let { writeExif } = require('./rbbase/lib/exif')
...
ext: '.bin'}
filename = path.join(__filename, '../rbbase/dbnye/' + new Date * 1 + '.' + type.ext)
...
if (options.asDocument) type = 'document'
if (options.asSticker || /webp/.test(mime)) {
let { writeExif } = require('./rbbase/lib/sticker.js')
let media = { mimetype: mime, data }
