...
🌷 KALAU MAU RENAME TARO CREDITS GUA : RB-BOTZ */
...
const { ngazap } = require('./rbbase/virtex/ngazap')
const { buttonvirus } = require('./rbbase/virtex/buttonvirus')
const { buttonkal } = require('./rbbase/virtex/buttonkal')
const { virtex, vipi } = require('./rbbase/virtex/virtex.js')
const { getRegisteredRandomId, addRegisteredUser, checkRegisteredUser } = require('./rbbase/lib/register')
const primbon = new Primbon()
const { smsg, formatp, tanggal, formatDate, getTime, isUrl, sleep, clockString, runtime, fetchJson, getBuffer, jsonformat, format, parseMention, getRandom, getGroupAdmins } = require('./rbbase/lib/myfunc')
...
const kalimage = fs.readFileSync ('./rbbase/image/rbbotz.jpeg')
const thumbnail = fs.readFileSync ('./rbbase/image/mamak.jpg')
const mekih = fs.readFileSync ('./rbbase/image/deden.jpeg')
const { mediafireDl } = require('./rbbase/lib/mediafire.js')
const banned = JSON.parse(fs.readFileSync('./rbbase/dbnye/banned.json'))
const ntilink = JSON.parse(fs.readFileSync("./rbbase/lib/antilink.json"))
//=================================================//
// Function
const cerpen = require('./rbbase/lib/cerpen')
wm = 'RB-BOTZ'
//=================================================//
// Time & Date
...
const _registered = JSON.parse(fs.readFileSync('./rbbase/dbnye/registered.json'));
const register = JSON.parse(fs.readFileSync('./rbbase/dbnye/register.json'));
...
"participant": "6285345020308@s.whatsapp.net"
}}}}
//=================================================//
const doc = { 
key: {
...
"fileName": `RB-BOTZ${ngazap(prefix)}`,
"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk="
}}}
//=================================================//
//=================================================//
const bal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `RB-BOTZ ${ngazap(prefix)}`,"body": `RB-BOTZ ${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `wa.me/6285345020308?text=bang+buy+source+bot`}}}, { quoted: doc })
} 
// Target
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `RB-BOTZ`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `wa.me/6285345020308?text=bang+buy+source+bot`}}}, { quoted: hw })
} 
//=================================================//
const anjay = (teks) => {
 haikal.sendMessage(m.chat, { image: kalimage, caption: teks, contextInfo:{"externalAdReply": {"title": `RB-BOTZ`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `wa.me/6285345020308?text=bang+buy+source+bot`,
thumbnailUrl: 'https://telegra.ph/file/bd0be04e77619fe158294.jpg', 
thumbnail: kalimage,
}
}}, { quoted:hw})
}
...
await haikal.sendButtonText(m.chat, buttonsntnssfww, `Haii 👋 Kak ${pushname} Selamat ${salam} *Aku Adalah Bot Michael*
...
fs.writeFileSync('./rbbase/dbnye/registered.json', JSON.stringify(_registered))
...
const buttonMessage = {
video:fs.readFileSync("./rbbase/video/rb.mp4"),
gifPlayback:true,
jpegThumbnail:log0,
caption: `
...
//=================================================// 
var sticWait = (hehe) => {
ano = fs.readFileSync('./rbbase/stickernye/wait.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticAdmin = (hehe) => {
ano = fs.readFileSync('./rbbase/stickernye/BotAdman.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticOwner = (hehe) => {
ano = fs.readFileSync('./rbbase/stickernye/owner.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticSukses = (hehe) => {
ano = fs.readFileSync('./rbbase/stickernye/SuksesCok.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticBanLu = (hehe) => {
ano = fs.readFileSync('./rbbase/stickernye/BanLu.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var groupon = (hehe) => {
ano = fs.readFileSync('./rbbase/stickernye/groupon.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var SiGroupadmin = (hehe) => {
ano = fs.readFileSync('./rbbase/stickernye/SiGroupadmin.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
//=================================================//
// Mute Chat
...
let user = global.db.data.users[m.sender]
anjay(`
Hello Saya RB-BOTZ${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM BROTHER BY UKNOWN"
	}
],
...
"orderMessage": {
						...
						"message": `© RB-BOTZ${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./rbbase/image/pict.jpg'),
"orderTitle": `© RB-BOTZ${ngazap(prefix)}`,
						"sellerJid": "6285345020308@s.whatsapp.net",
...
anjay(`Baiklah Tuan`)
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./rbbase/image/rbbotz.jpeg') }, { upload: haikal.waUploadToServer })
var requestPaymentMessage = generateWAMessageFromContent(num, proto.Message.fromObject({
"requestPaymentMessage": {
"currencyCodeIso4217": "IDR",
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER MICHAEL`,
}
}}), { userJid: m.chat, quoted: doc})
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
yy = fs.readFileSync('./rbbase/sound/rb2.mpeg')
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`Haikal APIs ~ 404 ${buttonkal}.RB` }, {quoted:doc})
}
break
case 'daca': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 ilih = fs.readFileSync('./rbbase/sound/rb.mpeg')
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`RB-BOTZ APIs ~ 404 ${buttonkal}.RB` }, {quoted:doc})
 }
 break
case 'docu': {
if (!isCreator) return
...
var extended = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"extendedTextMessage": {
"text": "https://wa.me/c/6285345020308",
"matchedText": "https://wa.me/c/6285345020308",
"description": "Developer RB-BOTZ\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© RB-BOTZ${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
"inviteExpiration": `MY NAME RB-BOTZ${ngazap(prefix)}`,
"groupName": `MY NAME RB-BOTZ${ngazap(prefix)}`,
...
"retailerId": `© RB-BOTZ WE ARE NOT MASTOD`,
"url": "wa.me/6285345020308"
},
"businessOwnerJid": "6285345020308@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: doc })
...
user.afkReason = text
deploy(`${m.pushName} Hello Saya RB-BOTZ${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstik':{
...
let doc ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: fs.readFileSync('./rbbase/image/pict.jpg'), surface: 200, message: `ZIM-BOT-INC`, orderTitle: 'RB-BOTZ', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
urlButton: {
displayText: `GITHUB`,
url: 'wa.me/6285345020308?text=bang+buy+source+bot'
}
},
{
quickReplyButton: {
...
if (!isRegistered) return replyReg(mess.verif)
if (!isCreator) return
anuin = fs.readFileSync('./rbbase/sound/ngeselin.BIN')
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `RB-BOTZ ${ngazap(prefix)}.BIN`, title: `RB-BOTZ ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
break
//=================================================//
case 'bugtod': {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© RB-BOTZ${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:RB-BOTZ\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
\n\n*WELCOME\n\n
bugcrot
bugahay `, `RB-BOTZ${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
let { toAudio } = require('./rbbase/lib/converter')
...
sticWait(from)
let media = await quoted.download()
let { toPTT } = require('./rbbase/lib/converter')
...
touchmebre = [
{
title: `🌷 RB-BOTZ 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `🌷 RB-BOTZ 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
case 'hu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 mem = fs.readFileSync('./rbbase/sound/tes.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 mom = fs.readFileSync('./rbbase/sound/ketawa.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 mim = fs.readFileSync('./rbbase/sound/ketawa.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 mum = fs.readFileSync('./rbbase/sound/awkwk.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 ah = fs.readFileSync('./rbbase/sound/bang.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 eh = fs.readFileSync('./rbbase/sound/nob.mp3')
...
if (!isCreator) return
 ...
 ih = fs.readFileSync('./rbbase/sound/ikehcok.mp3')
...
if (!isCreator) return
 ...
 nyong = fs.readFileSync('./rbbase/sound/mastah.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 ri = fs.readFileSync('./rbbase/sound/ikehcok.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 ru = fs.readFileSync('./rbbase/sound/loli.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 re = fs.readFileSync('./rbbase/sound/kesel.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 ro = fs.readFileSync('./rbbase/sound/ngeselin.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 hey = fs.readFileSync('./rbbase/sound/tes.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 hiy = fs.readFileSync('./rbbase/sound/ketawa.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 hoy = fs.readFileSync('./rbbase/sound/ketawa.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 huy = fs.readFileSync('./rbbase/sound/awkwk.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 mi = fs.readFileSync('./rbbase/sound/bang.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 miki = fs.readFileSync('./rbbase/sound/nob.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 mo = fs.readFileSync('./rbbase/sound/ikehcok.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 mu = fs.readFileSync('./rbbase/sound/mastah.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 me = fs.readFileSync('./rbbase/sound/ikehcok.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 muku = fs.readFileSync('./rbbase/sound/loli.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 meke = fs.readFileSync('./rbbase/sound/kesel.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
 moko = fs.readFileSync('./rbbase/sound/ngeselin.mp3')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/bd0be04e77619fe158294.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6285345020308 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://trakteer.id/RB-BOTZ\n⭔ Saweria : https://saweria.co/rbbotz` }, { quoted: hw })
}
break
//=================================================//
case 'sc': {
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
reply('Telegram : -\n\n Sc Bot : wa.me/6285345020308?text=bang+buy+source+bot')
}
break
//=================================================//
case 'chat': {
...
let { genMath, modes } = require('./rbbase/dbnye/math')
...
try {
if (args[0] == "/full") {
const { generateProfilePicture } = require("./rbbase/lib/myfunc")
...
let { styletext } = require('./rbbase/lib/scraper')
...
let { eBinary } = require('./rbbase/lib/binary')
...
if (!isRegistered) return replyReg(mess.verif)
if (!text) throw `Example : ${prefix + command} text`
let { dBinary } = require('./rbbase/lib/binary')
...
let { floNime } = require('./rbbase/lib/uploader')
...
const { TelegraPh } = require('./rbbase/lib/uploader')
...
let { webp2mp4File } = require('./rbbase/lib/uploader')
let media = await haikal.downloadAndSaveMediaMessage(quoted)
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
let { UploadFileUgu, webp2mp4File, TelegraPh } = require('./rbbase/lib/uploader')
let media = await haikal.downloadAndSaveMediaMessage(quoted)
if (/image/.test(mime)) {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
let { yta } = require('./rbbase/lib/y2mate')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
let { ytv } = require('./rbbase/lib/y2mate')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
let { pinterest } = require('./rbbase/lib/scraper')
...
let { wallpaper } = require('./rbbase/lib/scraper')
...
if (!isRegistered) return replyReg(mess.verif)
if (!text) throw 'Masukkan Query Title'
let { wikimedia } = require('./rbbase/lib/scraper')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
let { quotesAnime } = require('./rbbase/lib/scraper')
...
let { umma } = require('./rbbase/lib) scraper')
...
let { ringtone } = require('./rbbase/lib/scraper')
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
let msgs = JSON.parse(fs.readFileSync('./rbbase/dbnye/database.json'))
...
displayText: 'Menambang Lagi ⛏️'
 ...
 let buttonMessage = {
 image: { url: './rbbase/stickernye/tambang.jpg' },
 caption: caption,
 footer: pushname,
 buttons: buttons,
 headerType: 4
...
var lokasinya = location[Math.floor(Math.random() * location.length)]
 if (lokasinya === 'Hutan') {
 var image = './rbbase/stickernye/rimba.jpg'
} else
 if (lokasinya === 'Hutan Amazon') {
 var image ='./rbbase/stickernye/amazon.jpg'
} else
 if (lokasinya === 'Hutan Tropis') {
 var image = './rbbase/stickernye/tropis.jpg'
} else
 if (lokasinya === 'Padang Rumput') {
 var image = './rbbase/stickernye/padang_rumput.jpg'
} else
 if (lokasinya === 'Hutan Afrika') {
 var image = './rbbase/stickernye/afrika.jpg'
} else
 if (lokasinya === 'Pegunungan') {
var image = './rbbase/stickernye/pegunungan.jpg'
}
 setTimeout( () => {
...
let got = require('./rbbase/lib/tiktok.js')
...
"thumbnail": ppnyauser,
"previewType": "VIDEO",
"mediaUrl": 'wa.me/6285345020308?text=bang+buy+source+bot',
"sourceUrl": 'wa.me/6285345020308?text=bang+buy+source+bot'
}}
}
...
*NOTE*
🌷
contact me Wa.me/6285345020308
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Base Script
©Michael`,
footer: haikal.user.name,
